<?php
    ...
    {
        $params = [];
        return ProcessMethod("getMe", $params);
    }
    ...
    function SendInvoice($chatId, string $title, string $description, string $payload, string $providerToken, string $currency, string $prices, int $maxTipAmount = 0,
                         ...
                         bool $needShippingAddress = true, bool $sendPhoneNumberToProvider = true, bool $sendEmailToProvider = true, bool $isFlexible = true, int $replyToMessageId = 0, bool $allowSendingWithoutReply = true, string $replyMarkup = '')
    {
        $params =
        [
            'chat_id' => $chatId,
        ...
        ProcessMethod('sendInvoice', $params);
    }
    ...
    function AnswerShippingQuery(string $shippingQueryId, bool $ok, string $shippingOptions = '', string $errorMessage = '')
    {
        ...
        ProcessMethod('answerShippingQuery', $params);
    }
    ...
    function AnswerPreCheckoutQuery(string $preCheckoutQueryId, bool $ok, string $errorMessage = '')
    {
        ...
        ProcessMethod('answerPreCheckoutQuery', $params);
    }

    function ProcessMethod(string $method, $params)
    {
        if(!$curld = curl_init())
        {
            exit;
